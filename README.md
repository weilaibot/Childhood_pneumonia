# Childhood_pneumonia
## 🧠 Childhood_pneumonia Training Guide

This project uses the Childhood_pneumonia model for training on a custom dataset. Follow these steps to set up and train the model:
...
```bash
python -m venv Childhood_pneumonia
source Childhood_pneumonia/bin/activate  # On Windows: Childhood_pneumonia\Scripts\activate
```
